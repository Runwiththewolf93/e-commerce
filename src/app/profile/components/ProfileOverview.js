...
export default function ProfileOverview({ session }) {
  ...
  return (
    <div className="flex-grow bg-gray-100 rounded-md flex justify-center items-start p-6">
      <div>
        <p className="mb-3 text-5xl text-center font-semibold">
          Profile Overview
        </p>
        {!user ? (
          <ProfileOverviewSkeleton inputFields={inputFields} />
        ) : (
          <>
              ...
              <div className="mt-3">
                ...
                <div className="flex gap-3 mt-4">
                  <button
                    ...
                    onClick={() => router.push("/profile/reset")}
                  >
                    Reset Password
                  </button>
                  <button
            ...
            >
              <div className="text-center">
                <h2 className="text-2xl font-semibold">Update Your Address</h2>
